...
export default function Store() {
  ...
  { (e) => setSearch(e.target.value) } />
      ...
      <div className = "grid grid-cols-2 gap-4 mt-10"> {filterData?.map((d, idx) => (
            <div
        key = {idx} className =
            "relative flex flex-col justify-between mb-8 cursor-pointer group" >
            <div className = "overflow-hidden rounded-md">< Image
        src = {d?.image_path} alt = {d?.name} width = "0"
        height = "0"
        sizes = "100vw"
